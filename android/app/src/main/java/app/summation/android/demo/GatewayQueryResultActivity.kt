...
class GatewayQueryResultActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.gateway_query_result)
        setTitle("Gateway Query Result")
        ...
        Thread({
            ...
            if (response != null) {
                ...
                val json: JsonArray<*> = parser.parse(stringBuilder) as JsonArray<*>
                runOnUiThread({
